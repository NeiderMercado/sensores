...
<x-app-layout>
    ...
    <table class="table table-light">
        ...
        @endif
           <tbody>
             ...
             <center><h4>PRINCIPAL DEL PARQUE AUTOMOTOR DE COOTRAGAL</h4>
             <br>
    ...
    <tr>
        ...
        <td>
           <div>
   <form action="{{url('gestion_humana/operativo')}}" method="get">             
                <select id="developers" name="interno_hv" >
                    <input type="text" name="interno_hv" value="" required>
